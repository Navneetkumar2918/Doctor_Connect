...
void DOC::menu(){
    ...
    cout<<"|  DOCTOR IN YOUR MOBILE    |"<<endl;
    cout<<"|___________________________|"<<endl;
    ...
    switch(choice){
        ...
        case 1:
            ...
            if(mail=="doctorsinyourmobile@email.com" && pass=="Appoint_a_Doctor"){
                admin();
            }
            else{
...
void DOC::add(){
    ...
    cin>>dlname;
    cout<<"Enter department (Gynaecology,Dentist,Dermatologist,ENT Specialist (Ear,Nose,Throat),Gastroenterologist,Physician,Gynaecologist,Neurologist,Oncologist,Orthopaedic,Pediatrician,Psychiatrist etc.):"<<endl;
    cin>>dept;
    cout<<"Enter fees per visit:"<<endl;
    cin>>fee;
    cout<<"Enter visiting hour (Example: 10:00Am-9:00Pm):"<<endl;
    cin>>hour;
...
void DOC::list(){
    ...
    if(!data){
        ...
        cout << left << setw(10) << "Code" 
             ...
             << setw(20) << "Department" 
             << setw(10) << "Fees" 
             << setw(20) << "Visiting Hour" << endl;
        cout << "----------------------------------------------------------------------" << endl;

        data >> dcode >> dfname >> dlname >> dept >> fee >> hour;
        while(!data.eof()){
            cout << left << setw(10) << dcode 
                 << setw(25) << ("Dr." + dfname + " " + dlname)
                 << setw(20) << dept
                 << setw(10) << fee 
                 << setw(20) << hour << endl;
